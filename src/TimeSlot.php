...
final class TimeSlot {
  ...
  /**
   * Creates a TimeSlot from two DateTimeImmutable objects.
   *
   ...
   *
   * @return string
   *   A unique string key for this time slot.
   */
  ...
  /**
   * Start time expressed as total minutes since midnight.
   *
   * Useful for sorting.
   *
   * @return int
   *   The start time in minutes since midnight.
   */
